...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.recommend_button_1.setIcon(QtGui.QIcon('./config/p1.jpg'))  # 设置按钮图标
        ...
        self.recommend_button_2.setIcon(QtGui.QIcon('./config/p2.jpg'))
        ...
        self.recommend_button_3.setIcon(QtGui.QIcon('./config/p3.jpg'))
        ...
        self.recommend_button_4.setIcon(QtGui.QIcon('./config/p4.jpg'))
        ...
        self.recommend_button_5.setIcon(QtGui.QIcon('./config/p1.jpg'))
        ...
        self.playlist_button_1.setIcon(QtGui.QIcon('./config/p1.jpg'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon('./config/p2.jpg'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon('./config/p3.jpg'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon('./config/p4.jpg'))
        ...
        ''')
        self.setWindowOpacity(1.5)  # 设置窗口透明度
