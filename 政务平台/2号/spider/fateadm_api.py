...
def proxy():
    url = 'http://www.dongdongmeiche.cn/proxy/9ee03e169fcd11ea87d802fcdc4e7412'
...
def TestFunc(pred_type_id='304000002', just_flag=False, balances=False):
    ...
    # saderyu@126.com
    # 342208sa
    pd_id = "123416"  # 用户中心页可以查询到pd信息
    pd_key = "2ryZCJeIc6f39sUzmIddPtiSW9z/FFwg"
    app_id = "323416"  # 开发者分成用的账号，在开发者中心可以查询到
    app_key = "5eAjyh+DIz8cylRRkZrD2ceSBXroSjCT"
    # 识别类型，
